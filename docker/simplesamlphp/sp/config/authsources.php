...
if (!isset($_ENV['SIMPLESAMLPHP_SP_ENTITY_ID'])) {
    exit('Set env var SIMPLESAMLPHP_SP_ENTITY_ID to the ID the wiki SP should use');
}
if (!isset($_ENV['SIMPLESAMLPHP_IDP_ENTITY_ID'])) {
    exit('Set env var SIMPLESAMLPHP_IDP_ENTITY_ID to the ID of the IDP we connect to');
}
...
$config = [
    ...
    'wiki-sp' => [
        ...
        'entityID' => $_ENV['SIMPLESAMLPHP_SP_ENTITY_ID'],

        // The entity ID of the IdP this SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => $_ENV['SIMPLESAMLPHP_IDP_ENTITY_ID'],

        // The URL to the discovery service.
        // Can be NULL/unset, in which case a builtin discovery service will be used.
        'discoURL' => null,

        'privatekey' => 'wiki-sp.pem',
        'certificate' => 'wiki-sp.crt',
    ...
    */
    ...
    'example-userpass' => [
        ...
        // Give the user an option to save their usernamehttp://idp.docker:6102 for future login attempts
